...
```{r fig.height=5, fig.width=5, options(tigris_use_cache = TRUE)}
...
#aesthetic elements  
  theme(plot.title=element_text(size=20), legend.position="right", 
        legend.key.size = unit(0.5, 'cm'),legend.title = element_text(size=16), 
        legend.text = element_text(size=12), aspect.ratio = 1, 
        axis.text.x = element_text(angle = 270, hjust = 2, size = 14), 
